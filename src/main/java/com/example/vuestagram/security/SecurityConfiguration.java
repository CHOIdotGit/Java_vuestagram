...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        return http.sessionManagement(session ->
                ...
                .addFilterBefore(tokenAuthenticationFilter, UsernamePasswordAuthenticationFilter.class) // 인가 처리 전 - 스프링 시큐리티 인증 필터 실행하는 메소드(addFilterBefore)
                ...
                .build(); // 마지막에 꼭 빌드를 넣어야 빨간줄 - 에러가 사라진다.
    }
}
